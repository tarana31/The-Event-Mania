...
class RsvpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post rsvps_url, params: { rsvp: { email: @rsvp.email, event_id: @rsvp.event_id, guests: @rsvp.guests, name: @rsvp.name } }
    end
  ...
  test "should update rsvp" do
    patch rsvp_url(@rsvp), params: { rsvp: { email: @rsvp.email, event_id: @rsvp.event_id, guests: @rsvp.guests, name: @rsvp.name } }
